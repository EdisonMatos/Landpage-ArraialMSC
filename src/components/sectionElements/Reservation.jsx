        ...
        <div className="flex flex-col bg-white w-auto gap-2 py-2 justify-evenly m-auto">
            ...
            <div className="w-full flex flex-col gap-4">
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                ...
                <div className="flex flex-col tablet1:flex-row gap-4 m-auto items-center">
              ...
              <Button
                onClick={handleClick}
                className="mb-1 w-full phone3w-[78%] tablet1:w-[50%] h-[60px] m-auto"
                gap={false}
                size="small"
                label="Reservar"
              />
